<template>
  <div class="px-4 lg:px-0 mt-6 text-gray-200 max-w-screen-md mx-auto text-lg leading-relaxed">
    <p class="pb-6">
    ...
    <div class="border-l-4 border-gray-200 pl-4 mb-6 italic rounded">
    ...
    <h2 class="text-2xl text-orange-400 font-semibold mb-4 mt-4">Uneasy barton seeing remark happen his has</h2>
